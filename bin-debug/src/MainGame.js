...
var MainGame = (function (_super) {
    ...
    */
    ...
    MainGame.prototype.onGameEndTouched = function (e) {
        var _this = this;
        // replay
        if (e.target.name == 'replay') {
            ...
            var labelWechat = new egret.TextField();
            labelWechat.size = 30;
            ...
            setTimeout(function () {
                ...
                _this.removeChild(labelWechat);
                _this.btnReplay.touchEnabled = true;
                _this.btnWechat.touchEnabled = true;
            }, 4000);
        }
    };
